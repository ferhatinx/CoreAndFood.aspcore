<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Proje3_TarimSitesi.Default" %>
		...
		<div class="container-fluid px-lg-4">
			<nav class="py-4">
                        ...
                        <ul class="menu mt-md-3">
							...
							<li class="mr-lg-2"><a href="#news" class="scroll">Haberler</a></li>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="style-banner">
					<h1 class="text-white">Tarıma Hoşgeldiniz</h1>
					<p class="mt-5 text-white">Organik Taze Baklagil Denemek İstermisiniz </p>
