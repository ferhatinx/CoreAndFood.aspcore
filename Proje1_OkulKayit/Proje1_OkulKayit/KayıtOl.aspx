<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayıtOl.aspx.cs" Inherits="Proje1_OkulKayit.KayıtOl" %>
    ...
    <header>
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="Index.aspx">Benim Okulum</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="index.html" class="drop-text">İstatiksikler</a></li>
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        <label class="col-form-label">Kullancı Adı</label>
                        
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="Kullancı Adınız.." required=""></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Email</label>
                           <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" placeholder="Mailiniz.." required=""></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şehir</label>
                        <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" placeholder="Şehriniz.." required=""></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şifre</label>
                        <asp:TextBox ID="TextBox4" type="password" runat="server" CssClass="form-control" placeholder="********" required=""></asp:TextBox>
                    </div>
                    ...
                    <asp:Button class="btn btn-lg btn-warning" ID="Button1" runat="server" Text="Kayıt Ol" OnClick="Button1_Click" />
                </form>
            </div>
            <!-- //register -->
        </div>
