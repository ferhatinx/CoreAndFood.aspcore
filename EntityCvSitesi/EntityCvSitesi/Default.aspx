<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EntityCvSitesi.Default" %>
...
<body>
    ...
    <div class="main">
                        ...
                        <ItemTemplate>
                            <li>
                                <div class="row">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="<%#Eval("DERECE") %>" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </li>
                        </ItemTemplate>
        ...
        <section class="wedo" id="contact">
            <h3 class="w3_head mb-4 text-left">iLETİŞİM</h3>
            <form action="#" method="post" runat="server">
                <div class="row contact_top">
                    <div class="col-sm-6" style="margin-bottom: 20px">
                        <asp:TextBox ID="txtad" runat="server" placeholder="İsim" required="" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="col-sm-6" style="margin-bottom: 20px">
                        <asp:TextBox type="email" ID="txtmail" runat="server" placeholder="Email" required="" CssClass="form-control"></asp:TextBox>

                    </div>
                    <div class="col-sm-12" style="margin-bottom: 20px">
                        <asp:TextBox ID="txtkonu" runat="server" placeholder="konu" CssClass="form-control" required=""></asp:TextBox>
                    </div>

                    <div class="col-sm-12" style="margin-bottom: 20px;">
                         <asp:TextBox ID="txtmesaj" runat="server" placeholder="konu" CssClass="form-control" required="" TextMode="MultiLine"></asp:TextBox>
                ...
                <asp:Button ID="Button1" runat="server" Text="Mesajı Gönder" CssClass="btn btn-warning" OnClick="Button1_Click" />
                <button type="reset" class="btn">Tümünü Sil</button>
